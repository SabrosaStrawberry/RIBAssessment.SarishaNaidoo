...
### Running the project 
1. Remember to navigate to appsettings.json to set up your connection string to SQL SERVER
2. Remember to update the environment file in the angular project with the URL and port number that the API is running on
